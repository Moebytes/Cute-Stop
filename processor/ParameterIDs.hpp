...
public:
    ParameterID trigger;
    ParameterID stopTime;
    ParameterID startTime;
    ParameterID curve;
    ...
    static auto loadFromJSON() -> ParameterIDs {
        ...
        parameterIDs.trigger = getParameter("trigger");
        parameterIDs.stopTime = getParameter("stopTime");
        parameterIDs.startTime = getParameter("startTime");
        parameterIDs.curve = getParameter("curve");
    ...
    static auto isRandomizable(const String& key) -> bool {
